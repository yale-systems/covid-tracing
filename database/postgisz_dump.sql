...
--
COPY public.contacts (contact_id, first_name, last_name, email, phone_number, age_group, household, healthcare_worker, patient_id, contact_type, times_called, contact_call_status, contact_date, update_date, relationship, language, symptomatic, self_isolate, notes, isolated_from_patient) FROM '/contacts.csv' CSV HEADER;
...
COPY public.events (event_id, patient_id, start_time, end_time, confirmed, geom, notes) FROM '/events.csv' CSV HEADER;
...
COPY public.volunteers FROM '/volunteers.csv' CSV HEADER;

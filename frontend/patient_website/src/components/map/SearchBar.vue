<template>
        <input id="searchInput" ref="searchInput" placeholder="Choose a location">
</template>
...
export default {
    ...
    mounted() {
        ...
        this.map.controls[this.google.maps.ControlPosition.TOP_CENTER].push(this.$refs.searchInput);
        // bias autocomplete towards current bounds (will update on bound change)
        this.autocomplete.bindTo('bounds', this.map);
        // set the data fields to return when the user selects a place
        this.autocomplete.setFields(
            ['address_components', 'geometry']); //geometry: lat/lon; address: string
